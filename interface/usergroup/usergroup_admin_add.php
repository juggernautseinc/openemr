...
<div class="container">
    ...
    <table>
        <tr>
            <td>
                <span class="title"><?php echo xlt('Add User'); ?></span>&nbsp;
            </td>
            <td>
                <a class="btn btn-secondary btn-save" name='form_save' id='form_save' href='#'
                ...
                <form name='new_user' id="new_user" method='post' action="usergroup_admin.php">
                    ...
                    <table class="border-0" cellpadding='0' cellspacing='0' style="width:600px;">
                        <tr>
                            ...
                            <td style="width:220px;"><input type="text" name="rumple" style="width:120px;"
                                                            class="form-control"><span class="mandatory"></span></td>
                            <?php if (empty($GLOBALS['gbl_ldap_enabled']) || empty($GLOBALS['gbl_ldap_exclusions'])) { ?>
                                <td style="width:150px;"><span class="text"><?php echo xlt('Password'); ?>: </span></td>
                                <td style="width:250px;"><input type="password" style="width:120px;" name="stiltskin"
                                                                class="form-control"><span class="mandatory"></span>
                                </td>
                            <?php } else { ?>
                        ...
                        <tr>
                            ...
                            <td style="width:200px;"><span class='text'><?php echo xlt('Your Password'); ?>: </span>
                            </td>
                            <td class='text' style="width:280px;"><input type='password' name=adminPass
                                                                         style="width:120px;" value=""
                                                                         autocomplete='off' class="form-control"><font
                                    class="mandatory"></font></td>

                        </tr>
                        <tr>
                            <td><span
                                    class="text"<?php echo ($GLOBALS['disable_non_default_groups']) ? " style='display: none'" : ""; ?>><?php echo xlt('Groupname'); ?>: </span>
                            </td>
                            <td>
                                <select name="groupname"
                                        class="form-control"<?php echo ($GLOBALS['disable_non_default_groups']) ? " style='display:none'" : ""; ?>>
                                    <?php
...
<input type="checkbox" name="portal_user"/></span>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name='fname' id='fname' style="width:120px;"
                                       class="form-control"><span class="mandatory"></span></td>
                            <td><span class="text"><?php echo xlt('Middle Name'); ?>: </span></td>
                            <td><input type="text" name='mname' style="width:120px;" class="form-control"></td>
                        </tr>
                        <tr>
                            <td><span class="text"><?php echo xlt('Last Name'); ?>: </span></td>
                            <td><input type="text" name='lname' id='lname' style="width:120px;"
                                       class="form-control"><span class="mandatory"></span></td>
                                ...
                                <select style="width:120px;" name=facility_id class="form-control">
                                    ...
                                    if ($fres) {
                                        ...
                                        foreach ($result as $iter) {
                                            ?>
                                            <option
                                                value="<?php echo attr($iter['id']); ?>"><?php echo text($iter['name']); ?></option>
                                            <?php
                                        }
                                    }
                                    ?>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name='federaltaxid' style="width:120px;" class="form-control"></td>
                            <td><span class="text"><?php echo xlt('DEA number'); ?>: </span></td>
                            <td><input type="text" name='federaldrugid' style="width:120px;" class="form-control"></td>
                        </tr>
                        <tr>
                            <td><span class="text"><?php echo xlt('UPIN'); ?>: </span></td>
                            <td><input type="text" name="upin" style="width:120px;" class="form-control"></td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="npi" style="width:120px;" class="form-control"></td>
                            <td><span class="text"><?php echo xlt('Job Description'); ?>: </span></td>
                            <td><input type="text" name="specialty" style="width:120px;" class="form-control"></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="taxonomy" style="width:120px;" class="form-control"
                                       value="207Q00000X"></td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="state_license_number" style="width:120px;"
                        ...
                        <tr>
                            <td><span class="text"><?php echo xlt('Weno Provider ID'); ?>: </span></td>
                            <td><input type="text" name="erxprid" style="width:120px;" class="form-control"
                                       value="<?php echo attr($iter["weno_prov_id"]); ?>"></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><textarea name=info style="width:120px;" cols='27' rows='4' wrap='auto'
        ...
        <tr<?php echo ($GLOBALS['disable_non_default_groups']) ? " style='display:none'" : ""; ?>>
            ...
            <td>
                <span class="text"><?php echo xlt('Groupname'); ?>: </span><input type="text" name='groupname'
                                                                                  size='10'>
                &nbsp;&nbsp;&nbsp;
